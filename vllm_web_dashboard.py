...
.pause-btn{display:inline-flex;align-items:center;justify-content:center;min-width:22px;height:20px;padding:0 5px;border-radius:5px;color:var(--accent);cursor:pointer;user-select:none;font-size:10px;letter-spacing:-1px;border:1px solid transparent}
