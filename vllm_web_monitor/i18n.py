...
tip_hist_ptok:'Скорость обработки вводных токенов (prefill) во времени. Пики = пришёл крупный prompt. Внизу текущее значение.',
...
tip_hist_ptok:'Input-token (prefill) processing rate over time. Peaks = a large prompt arrived. Current value shown below.',
